        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="/level" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Level User</p>
                </a>
              </li>
                  ...
                  <div class="">
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="level_kode" class="form-control" placeholder="Enter Level Code">
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <!-- text input -->
                      <div class="form-group">
                        ...
                        <input type="text" name="level_nama" class="form-control" placeholder="Enter Level Name">
                      </div>
                    </div>
                  </div>
                  <div class="card-footer">
                    <input type="submit" class="btn btn-primary"></input>
                    <a href="/level" class="btn btn-danger">Back</a>
                  </div>
                </form>
              </div>
